...
class Asset(object):
    def __init__(self, api):
        ...
        self.excluded_ip.history = Endpoint(
            api, "/asset/excluded_ip/history", "history"
        )
        ...
        self.host.vm.detection = Endpoint(
            api, "/asset/host/vm/detection", "host_list_vm_detection", "host"
        )
...
class Setup(object):
    def __init__(self, api):
        self.restricted_ips = Endpoint(
            api, "/setup/restricted_ips", "restricted_ips", "ip_set"
        )
